...
type BookingDetailsRailProps = {
  ...
  activities: BookingDetailsRailActivity[];
  booking: BookingDetailsItem;
  canResubmit: boolean;
};

type BookingDetailsRailActivity = {
...
/**
 * Formats the preferred customer name for rail display.
 *
 ...
 */
function includesFunDiveActivity(activities: BookingDetailsRailActivity[]) {
